...
import ru.novikov.dto.MeasurementDTO;
import ru.novikov.dto.MeasurementResponse;
...
public class DrawChart {
    ...
    private static List<Double> getTemperaturesFromServer() {
        ...
        if (jsonResponse == null || jsonResponse.getMeasurement() == null)
            return Collections.emptyList();

        return jsonResponse.getMeasurement().stream().map(MeasurementDTO::getValue)
